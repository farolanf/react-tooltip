...
content, html, isOpen, setIsOpen, }) => {
    ...
    return (jsxs(WrapperElement, { id: id, role: "tooltip", className: classNames('react-tooltip', styles['tooltip'], styles[variant], className, {
            [styles['show']]: hasContentOrChildren && !calculatingPosition && (isOpen || show),
            [styles['fixed']]: positionStrategy === 'fixed',
            [styles['clickable']]: clickable,
        }), style: { ...externalStyles, ...inlineStyles }, ref: tooltipRef, children: [children || (html && jsx(TooltipContent, { content: html })) || content, jsx("div", { className: classNames('react-tooltip-arrow', styles['arrow'], classNameArrow, {
